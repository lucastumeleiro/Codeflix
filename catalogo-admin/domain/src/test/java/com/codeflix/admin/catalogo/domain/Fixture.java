...
public final class Fixture {
    ...
    public static Video video() {
        return Video.newVideo(
                ...
                Set.of(CastMembers.lucas().getId(), CastMembers.geo().getId())
        );
    }
    ...
    public static final class CastMembers {
        ...
        private static final CastMember LUCAS =
                CastMember.newMember("Lucas Tumeleiro", CastMemberType.ACTOR);

        private static final CastMember GEO =
        ...
        public static CastMember geo() {
            return CastMember.with(GEO);
        }
    }
